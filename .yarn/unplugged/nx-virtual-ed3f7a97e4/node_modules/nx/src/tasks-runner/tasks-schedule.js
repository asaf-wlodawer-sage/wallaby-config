...
class TasksSchedule {
    ...
    scheduleBatches() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            for (const root of this.notScheduledTaskGraph.roots) {
                ...
                const executorName = yield (0, utils_1.getExecutorNameForTask)(rootTask, this.projectGraph);
    ...
    processTaskForBatches(batches, task, rootExecutorName, isRoot) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const executorName = yield (0, utils_1.getExecutorNameForTask)(task, this.projectGraph);
            ...
            for (const dep of this.reverseTaskDeps[task.id]) {
                ...
                yield this.processTaskForBatches(batches, depTask, rootExecutorName, false);
            }
        });
    }
    canBatchTaskBeScheduled(taskId, batchTaskGraph) {
        // all deps have either completed or belong to the same batch
        return this.taskGraph.dependencies[taskId].every((id) => this.completedTasks.has(id) || !!(batchTaskGraph === null || batchTaskGraph === void 0 ? void 0 : batchTaskGraph.tasks[id]));
    }
