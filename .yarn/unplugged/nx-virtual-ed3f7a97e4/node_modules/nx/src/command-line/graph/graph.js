...
function createFileWatcher() {
    return client_1.daemonClient.registerFileWatcher({ watchProjects: 'all', includeGlobalWorkspaceFiles: true }, debounce((error, changes) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        var _a;
        if (error === 'closed') {
